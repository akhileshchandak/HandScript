package com.example.akhilesh.fontchat;
...
/**
 * Created by devesh on 02-04-2017.
 */
public class ChatArrayAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public View getView(int position,View ConvertView, ViewGroup parent){
        ...
        Typeface custom_font = Typeface.createFromAsset(getContext().getAssets(), "fonts/HandScript.ttf");
